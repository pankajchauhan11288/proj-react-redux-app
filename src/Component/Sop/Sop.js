...
const Sop = () => {
    ...
    const {WithdrowMoney,DipositMoney} = bindActionCreators(ActionCreators,dispatch);
  return (
    <>
    ...
    <button className="btn btn-primary mx-2" onClick={()=>{WithdrowMoney(100)}}>-</button>
    <span className='bg-dark text-light'>Current Amount : {amount}</span>
